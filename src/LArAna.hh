...
namespace numi {
  ...
  private:
    ...
    std::vector< Bool_t >   fCCint;
    std::vector< Bool_t >   fCCQEint;
    std::vector< Bool_t >   fNCint;
    std::vector< Bool_t >   fNCQEint;
  ...
  public:
    ...
    inline const std::vector< Bool_t >&   CCint()          const { return fCCint;           }
    inline const std::vector< Bool_t >&   CCQEint()        const { return fCCQEint;         }
    inline const std::vector< Bool_t >&   NCint()          const { return fNCint;           }
    inline const std::vector< Bool_t >&   NCQEint()        const { return fNCQEint;         }
